...
Các doanh nghiệp SME tại Việt Nam gặp khó khăn trong việc tự đánh giá sức khỏe tài chính, so sánh các gói vay ngân hàng, và ra quyết định vay vốn do thông tin về lãi suất, điều kiện vay và các chỉ số tài chính bị phân mảnh.

**Ai đang gặp vấn đề này?**  
Chủ doanh nghiệp vừa và nhỏ, cán bộ tài chính tại các SME chưa có công cụ phân tích chuyên nghiệp.

**Vì sao vấn đề này đáng quan tâm?**  
Theo thống kê, SME chiếm hơn 90% số lượng doanh nghiệp tại Việt Nam và đóng góp lớn vào GDP. Khả năng tiếp cận tín dụng hiệu quả là yếu tố sống còn cho sự phát triển của nhóm doanh nghiệp này. Một công cụ phân tích tài chính toàn diện, dễ sử dụng sẽ giúp SME ra quyết định vay vốn chính xác hơn, giảm rủi ro tài chính.

## Người dùng mục tiêu

**Người dùng chính của sản phẩm là ai?**  
Chủ doanh nghiệp SME và quản lý tài chính tại các doanh nghiệp vừa và nhỏ.
...
- **So sánh gói vay ngân hàng (8 tiêu chí):** Chấm điểm và xếp hạng các gói vay dựa trên lãi suất (25%), khả năng trả nợ (20%), hạn mức, thời hạn, LTV, đòn bẩy DN, thu nhập và phí xử lý.
...
- **Dữ liệu vĩ mô:** Lấy từ API công khai của World Bank (GDP, lạm phát), SBV (Lãi suất chính sách) và ExchangeRate-API (tỷ giá USD/VND).
